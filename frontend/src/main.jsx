...
const DEPOSIT_ADDRESS = "TQRbWCfqDhkrFCaTGcZScvkKMjkzaGUhW6";
  ...
  return <section>
    ...
    <div className="deposit-layout">
      <div className="deposit-card">
        <img src={`https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=${DEPOSIT_ADDRESS}`} alt="Deposit QR Code" className="w-full max-w-[200px] mx-auto rounded-lg"/>
